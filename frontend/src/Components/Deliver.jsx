...
const Deliver = () => {
  ...
  return (
    <div>
      <div
        className="md:hidden lg:block w-full bg-cover bg-center bg-no-repeat text-center 2xl:pt-[3%]  p-[7%] 2xl:mb-[10rem] mb-0 md:mb-[3rem] sm-912:h-[54vh] lg-1440:h-[85vh]   relative 2xl:h-[100vh] md:h-[83vh] sm-820:h-[65vh]  lg:h-[85vh]  xl:h-[700px]  h-auto bg-[#F8F5F1]"
      ...
      >
        ...
        <div className="text-left md:text-center ">
          ...
          <img
            ...
            className="absolute 2xl:left-[45%] 2xl:top-[5rem] xl:w-[21%] lg-1440:w-[18%]  lg-1440:left-[40rem] lg-1440:top-[7.5rem] xl:top-[7rem] xl:left-[32rem] 2xl:w-[12%]  w-[55%] left-[1rem] top-[2.5rem] md:w-[32%] md:top-[4.5rem] md:left-[19rem] lg:w-[25%]  lg:top-[5.5rem] lg:left-[25rem]"
          /> */}

          <div className="w-full text-center">
            <Heading heading_text="  Our Working Process!" align="center" />
          </div>
          ...
          <div className="absolute  top-[65%] md:top-[76%] xl:top-[85%] lg:top-[83%] md:left-[10%] 2xl:left-[14%] left-[15%] text-left hidden md:block  ">
            <div className="">
              <img
                src={parcel}
                className="absolute  right-[15rem] top-[-9.1rem] w-[30%] h-full lg:right-[10rem] lg:w-[40%] lg:top-[-8rem] md:right-[4rem] md:top-[-7.8rem] sm-912:top-[-7.9rem] md:w-[45%] xl:w-[30%] 2xl:w-[30%] 2xl:right-[14rem] xl:top-[-8.4rem] 2xl:top-[-9.1rem]"
              />
            </div>
            <div
              className="md:w-[90%] bg-right p-[3%] md:p-[3rem] md:h-[23vh] lg:h-[30vh] xl:h-[55vh] 2xl:h-[35vh] sm-912:h-[18vh]  lg-1440:h-[40vh] md:pt-[2%] "
            ...
            >
              ...
              <img
                src={HorizontalBorder}
                className="absolute left-[3%] top-[33%]  md:w-[31%] lg:w-[23%]  w-[80%] xl:w-[20%]  2xl:top-[12%] xl:top-[12%] md:top-[10%] lg:top-[12%] md:left-[2rem] "
              /> */}
              <Heading heading_text=" Our Working Process!" />
              ...
              <div className="flex items-center bg-[#FE6204]  text-white hover:bg-white hover:text-[#FE6204]  w-[23%] md:w-[28%] lg:w-[26%] xl:mt-[3%] xl:w-[22%] px-[3%] 2xl:w-[17%]  rounded-md mt-[4%] lg:mt-[4%] ">
                <a
                  href="/contact"
            ...
            <div
              className="md:flex md:w-[90%] hidden  "
              data-aos="zoom-out"
              data-aos-easing="linear"
              data-aos-duration="500"
            >
      ...
      {/* mobile */}
      <div className=" lg:hidden p-[5%] md:h-[1145px] h-[1135px]">
        <div
          className=" w-full bg-cover bg-center  text-center mt-[2rem] relative h-full p-[7%] "
          style={{ backgroundImage: `url(${parcel_bg})` }}
        >
          <div className="relative mt-[1rem] text-left">
            ...
            <img
              src={HorizontalBorder}
              className="absolute 2xl:left-[45.5%] 2xl:top-[8%]  2xl::w-[11%] md:w-[40%] w-[70%] left-[-0.5rem] top-[1rem] "
            />
          ...
          <div>
            {data.map((item, index) => (
              <div
                className="flex justify-around bg-[#F8F5F1] rounded-md py-[1rem] px-[0.1rem] mb-4"
                key={item.id || index}
              >
                <div>
                  <img
                    src={item.img}
                    className="w-[10rem] md:w-[7rem] h-[5rem] mt-[1rem]"
                  />
                </div>
          ...
          <div className="flex items-center bg-[#FE6204]  text-white text-center hover:bg-white hover:text-[#FE6204] mx-auto  w-fit px-[5%] md:mt-[7%]  rounded-md mt-[9%]  ">
            <a
              href="/contact"
              className=" px-3 md:px-0 md:py-3 2xl:px-[0rem] 2xl:py-[1rem]  py-4 rounded-lg text-lg md:text-base  lg:text-lg font-medium transition hover:cursor-pointer"
            >
              Book Your Parcel
            </a>
          </div>
