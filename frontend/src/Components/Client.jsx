...
const Client = () => {
  ...
  return (
    ...
    data-aos-duration="200">
      <div
        className="md:w-[100%] w-[100%] mx-auto 2xl:mt-[3rem] md:mt-[2rem] bg-cover md:p-[7%] 2xl:p-[3%] p-[12%] bg-center bg-no-repeat h-auto xl:h-[700px]  relative "
      ...
      >
        <div className="relative md:text-center text-left">
          ...
          <img
            ...
            className="absolute md:left-[35%] lg:left-[38%]   lg:w-[26%] xl:w-[20%] xl:top-[23%] xl:left-[41%] 2xl:w-[12%] 2xl:left-[45%] 2xl:top-[29%]  left-[-0.5rem] lg:top-[18%] md:top-[16%] top-[1.3rem] md:w-[3%] w-[70%]  mt-[-2%]"
          /> */}
          {/* <Heading heading_text=" Clients Testimonials"/> */}
          <div className="w-full text-center ">
            <Heading heading_text="Clients Testimonials" align="center" />
          </div>
        ...
        <div className="xl:w-[93%] 2xl:w-[85%]  mx-auto">
          <Slider
            {...sliderSettings}
            ref={sliderRef} // Add horizontal spacing
          >
            {data.map((item, index) => (
              <div key={item.id || index} className="px-2">
                ...
                {/* Add padding here */}
                <div
                  className="bg-[#F8F5F1]   p-[1rem] mt-[2%] relative rounded-md 2xl:mb-[2rem] md:mb-[3rem] lg:mb-[1rem] mb-[1rem]  "
                  key={item.id || index}
                >
