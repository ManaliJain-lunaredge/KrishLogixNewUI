...
const ArticleCard = ({
  ...
  <div className="p-2 "  data-aos={aos}
  ...
  return (
    <div>
      ...
      <div className="bg-[#F8F5F1] 2xl:p-0 p-[5%]" id="team">
        <div
          className={`lg:w-[100%] w-[100%] 2xl:w-[86.5%] xl:w-[95%] mx-auto p-[3%] py-[10%] md:py-[3%] mt-[3%] ${
            isBlogs && "2xl:my-0"
          }`}
        >
          <div className="relative">
            <div className="2xl:ms-[1rem]">
             ...
             <Heading heading_text="Blogs & News updates" align="left"/>
              {/* <img
                src={HorizontalBorder}
                alt="Border"
                className="absolute left-[0%] top-[13%] md:top-[10%] 2xl:w-[15%] lg:w-[27%] lg:top-[13%] 2xl:top-[15%] 2xl:left-[0.5rem] lg:left-[-1%] xl:w-[22%]  md:w-[35%] w-[65%]"
              /> */}
            ...
            <div className="md:flex top-[3rem] hidden absolute right-[5%] xl:right-[3%] cursor-pointer items-center bg-[#FE6204] text-white xl:w-[17%] 2xl:w-[12%]  lg:w-[20%]  md:w-[27%] hover:bg-[#290068] px-[1%] py-[0.5%] rounded-md">
              <Link
                to="/blogs"
