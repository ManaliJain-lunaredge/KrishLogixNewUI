    ...
    <div>
     {
      isAbout ?( <div
        ...
        <div className="text-center p-2 ">
          <h3 className="text-white font-semibold 2xl:text-5xl pt-[4rem] 2xl:pt-0  md:text-4xl lg:text-4xl text-4xl mb-[1%]">
            About<span className="text-[#FE6204]"> Us</span>
          </h3>
      ...
      <div
        className={`md:w-[90%] 2xl:w-[75%] lg:w-[90%] w-[100%] mx-auto text-center md:flex lg:pt-[7rem]  pt-[5rem] pb-[1%] 2xl:pt-[12%]  ${isAbout &&"2xl:pt-[5rem] pb-[4rem]"}`}
        id="about"
      >
        <div className="2xl:p-0 p-3 md:p-0 flex justify-center items-center">
          {/* <img src={about} className="w-full  h-full" /> */}
          <img
            src={about}
            className="md:w-[100%] lg:w-[100%] 2xl:w-[80%] lg:ms-[7rem]  xl:w-[82%] flex w-[90%] h-auto ms-[4%] object-cover"
          />
        </div>
        <div className=" text-left   relative 2xl:p-0 p-[7%] ">
          <h5 className="text-[#FE6204] md:text-md lg:text-xl text-base font-medium ms-1 ">
            Trusted Path to Global Shipping!
          </h5>
          <img
            src={HorizontalBorder}
            className="md:w-[82%] 2xl:w-[60%] w-[80%] lg:top-[5rem] xl:top-[7rem] xl:w-[50%] lg:w-[75%] absolute top-[2.5rem] md:top-[4rem] 2xl:top-[1rem]   2xl:left-[0rem] "
          />
          ...
          <p className="mt-[6%] md:text-sm lg:text-xl ">
          ...
          <div>
            <div className="  mt-[8%] gap-5 md:gap-1 lg:gap-5">
              <div className="flex space-x-3 2xl:mb-[2rem] ">
                <div className="bg-[#FE6204] text-white rounded-md flex justify-center items-center md:w-[5rem] md:h-[3rem]  2xl:h-[4rem] w-[5rem] h-[3rem] mt-[1%] ">
                  <img src={carbon_storm_tracker} className="md:h-6 lg:h-8 h-7" />
                </div>
                <div>
                  <h3 className="text-[#290068] font-bold xl:text-lg 2xl:text-xl">
                    Real-Time Tracking
                  </h3>
              ...
              <div className="flex space-x-3">
                <div className="bg-[#FE6204] text-white rounded-md flex justify-center items-center   md:w-[5rem] md:h-[3rem] 2xl:h-[4rem] w-[5rem] h-[3rem] mt-[1%]">
                  <img src={solar_global} className="md:h-6 lg:h-8 h-7" />
                </div>
                <div>
                  <h3 className="text-[#290068] font-bold xl:text-lg 2xl:text-xl">
                    Global Leaders
            ...
            <div className="  mt-[10%] ">
              ...
              <div className=" xl:flex hidden gap-12">
                <a
                  href="#contact"
                  className="bg-[#FE6204] hover:bg-[#290068] hover:cursor-pointer  px-[3%]  py-[3%] 2xl:w-[70%] h-[50%] text-lg rounded-md flex  justify-center items-center font-semibold text-white"
                >
                  More About us
                </a>
                <div className="flex gap-3 ">
                  ...
                  <div>
                    ...
                    <p className="text-[#666666] text-base">
                      <a href="tel:+919876543214">+91 9876543214</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className=" xl:hidden block space-x-16 space-y-6 ">
                ...
                <a
                  href="#contact"
                  className="bg-[#FE6204] px-[10%] lg:w-[65%]  py-[3%] w-[70%] md:w-[75%] h-[50%] hover:bg-[#290068] hover:cursor-pointer text-lg rounded-md flex  justify-center items-center font-semibold text-white"
                >
                  More About us
                </a>
              </div>
