      ...
      >
        ...
        <div className="relative z-10">
          <div className=" text-center h-[500px]">
            ...
            <div className="p-2">
              {" "}
              <h3 className="text-white font-semibold 2xl:text-4xl md:text-2xl lg:text-4xl xl:mt-[5%] text-lg mt-[33%] md:mt-[14%] 2xl:mt-[7%] lg:mt-[8%] mb-[1%]">
                Driving Excellence,{" "}
        ...
        <div className="absolute md:top-[73%] lg:top-[24rem] top-[26rem] 2xl:left-[20%] 2xl:top-[26rem]  xl:top-[24rem] xl:left-[13%] md:left-[20%] lg:left-[13%]  left-[3rem]  text-center">
          <img
            src={bus}
            className="md:w-[80%] lg:w-[75vw] 2xl:w-[60vw] xl:h-[47vh] 2xl:h-[50vh] w-[85%] h-[80%] lg:h-[36vh] "
          />
        </div>
      </div>
    </div>
